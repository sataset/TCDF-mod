...
# uncomment this line to run in VSCode
# import os
# import sys
...
def main(datafiles, evaluation):
    if evaluation:
        ...
        for level in range(0, levels):
            receptivefield += (kernel_size - 1) * dilation_c**(level)
